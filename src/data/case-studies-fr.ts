export const caseStudiesFr = [
  ...
  },
  {
    ...
    location: 'Ottawa',
    eyebrow: "Cas réel de réparation après infiltration",
    h1: "Réparation intérieure après infiltration sur un VR à Ottawa",
    lead: "Quand l'eau a déjà commencé à atteindre les matériaux intérieurs, une simple reprise de joints ne suffit plus. Il faut confirmer la source et remettre les zones touchées en état de façon méthodique.",
    intro: "Ce cas illustre une situation où le dommage visible à l'intérieur montrait que l'infiltration avait dépassé le stade de l'entretien préventif.",
    highlights: [
      "Diagnostic avant remise en état",
      'Zones intérieures touchées par l’eau',
      'Réparation structurée',
      'Cas traité pour Ottawa'
    ],
    heroChecklist: [
      "Dommages déjà visibles à l'intérieur",
      'Besoin de distinguer cause et conséquence',
      'Remise en état orientée durable'
    ],
    problemTitle: 'Le problème observé',
    problemBody: "Le véhicule présentait des signes déjà avancés: surfaces intérieures touchées, indices d'humidité et besoin de confirmer l'étendue réelle du dommage avant d'intervenir.",
    problemPoints: [
      'Matériaux intérieurs atteints',
      "Lecture nécessaire de l'origine de l'eau",
      'Risque de refaire une surface sans traiter la vraie cause'
    ],
    workTitle: "Ce qui a été fait",
    workBody: "Le dossier a été abordé comme une réparation complète: diagnostic, ciblage de la zone d'entrée d'eau, puis remise en état des secteurs touchés selon l'ampleur du problème.",
    workPoints: [
      "Validation de la source d'infiltration",
      'Évaluation des zones intérieures à reprendre',
      'Plan de réparation logique plutôt qu’une correction visuelle rapide'
    ],
    resultTitle: 'Le résultat',
    resultBody: "Le client a pu avancer avec une réparation mieux structurée, adaptée au dommage réel, au lieu de multiplier les correctifs partiels sans régler le fond du dossier.",
    resultPoints: [
      'Réparation orientée sur la cause',
      'Meilleure cohérence entre diagnostic et travaux',
      'Remise en état plus crédible pour la suite'
    ],
    valueCards: [
      {
        title: 'Pourquoi ce cas compte',
        text: "Quand l'eau atteint déjà les finis intérieurs, la priorité n'est plus seulement l'étanchéité: il faut aussi gérer les conséquences du dommage."
      },
      {
        title: 'Service lié',
        text: "Ce genre de cas relève surtout de la réparation spécialisée, parfois précédée d'une inspection si la source n'est pas entièrement confirmée."
      }
    ]
  },
  {
    slug: 'reprise-scellants-vr-gatineau',
    title: 'Reprise de scellants extérieurs sur un VR à Gatineau',
    metaTitle: "Cas réel: reprise de scellants extérieurs de VR à Gatineau | Clinique du VR",
    metaDescription: "Cas réel de reprise de scellants extérieurs sur un VR à Gatineau: joints fissurés, intervention préventive et protection contre l'infiltration d'eau.",
    location: 'Gatineau',
    eyebrow: "Cas réel d'entretien préventif",
    h1: 'Reprise de scellants extérieurs sur un VR à Gatineau',
    lead: "Le dossier ne demandait pas encore une grosse réparation, mais les scellants extérieurs montraient assez de fatigue pour justifier une intervention avant qu'un problème d'eau n'apparaisse.",
    intro: "Ce type de travail est typiquement ce qui permet d'éviter qu'un entretien repoussé se transforme plus tard en infiltration d'eau et en réparation intérieure.",
    highlights: [
      'Joints extérieurs repris au bon moment',
      'Prévention des infiltrations',
      'Entretien d’étanchéité',
      'Cas traité à Gatineau'
    ],
    heroChecklist: [
      'Scellants fissurés ou fatigués',
      "Intervention avant l'entrée d'eau",
      'Prévention rentable par rapport à une réparation'
    ],
    problemTitle: 'Le problème observé',
    problemBody: "Les joints extérieurs présentaient des signes d'usure suffisants pour augmenter le risque d'infiltration autour des ouvertures et des raccords.",
    problemPoints: [
      'Scellants fissurés ou irréguliers',
      'Zones sensibles autour des ouvertures',
      "Besoin d'intervenir avant les dommages intérieurs"
    ],
    workTitle: "Ce qui a été fait",
    workBody: "Les anciens scellants problématiques ont été ciblés, les zones préparées et les secteurs sensibles remis en meilleur état pour rétablir une protection plus fiable contre l'eau.",
    workPoints: [
      'Retrait des sections compromises',
      'Préparation des surfaces concernées',
      "Reprise des zones exposées pour améliorer l'étanchéité"
    ],
    resultTitle: 'Le résultat',
    resultBody: "Le VR a retrouvé une meilleure protection sur ses points sensibles avant que l'eau ne puisse s'infiltrer et atteindre des matériaux plus coûteux à reprendre.",
    resultPoints: [
      'Risque de fuite réduit',
      'Entretien préventif rentable',
      'Meilleure tranquillité avant la saison'
    ],
    valueCards: [
      {
        title: 'Pourquoi ce cas compte',
        text: "Beaucoup de gros dossiers commencent par des joints fatigués qui auraient pu être repris plus tôt à moindre coût."
      },
      {
        title: 'Service lié',
        text: "Ce type de cas correspond à l'entretien recommandé quand le problème n'a pas encore dépassé le stade de la prévention."
      }
    ]
  }
];

export type CaseStudyFr = (typeof caseStudiesFr)[number];
